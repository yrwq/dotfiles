...
This repository contains my personal collection of configuration files for the [software i use](https://yrwq.github.io/software).

Other resources that define my system:

- <a href="https://github.com/yrwq/bin" target="_blank">bin</a> scripts to make my life easier
- <a href="https://github.com/yrwq/emacs" target="_blank">emacs</a> emacs configuration
...
check out other branches for my old linux dotfiles.
