...
let s:black   = ['#ffffff', 8]
let s:red     = ['#a37679', 9]
let s:green   = ['#87a376', 10]
let s:yellow  = ['#a39b76', 11]
let s:blue    = ['#758ba3', 12]
let s:magenta = ['#9f76a3', 13]
let s:cyan    = ['#899ca1', 14]
let s:white   = ['#5a5b5c', 15]

let s:bright_black    = ['#ffffff', 0]
let s:bright_red      = ['#755a5b', 1]
let s:bright_green    = ['#68755a', 2]
let s:bright_yellow   = ['#756e5a', 3]
let s:bright_blue     = ['#5b6976', 4]
let s:bright_magenta  = ['#755b76', 5]
let s:bright_cyan     = ['#465457', 6]
let s:bright_white    = ['#3d3e3d', 7]
