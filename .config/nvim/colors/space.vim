...
let s:black   = ['#111314', 8]
let s:red     = ['#945151', 9]
let s:green   = ['#7a7d43', 10]
let s:yellow  = ['#946b47', 11]
let s:blue    = ['#63808f', 12]
let s:magenta = ['#85668a', 13]
let s:cyan    = ['#567b77', 14]
let s:white   = ['#aab3aa', 15]

let s:bright_black    = ['#3a3e42', 0]
let s:bright_red      = ['#b94545', 1]
let s:bright_green    = ['#aaae49', 2]
let s:bright_yellow   = ['#d49256', 3]
let s:bright_blue     = ['#4993b9', 4]
let s:bright_magenta  = ['#ab6eb5', 5]
let s:bright_cyan     = ['#5eaaa3', 6]
let s:bright_white    = ['#e3e8e3', 7]
