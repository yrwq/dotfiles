...
local dock = require("module.dock." .. docky_theme)

local dock_placement = function(w)
    return awful.placement.right(w)
end
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.placement.right(s.dock_activator)
    ...
    local function adjust_dock()
        ...
        s.dock_activator.height = s.dock.height + dpi(250)
        -- And recenter
        awful.placement.right(s.dock_activator)
    end
