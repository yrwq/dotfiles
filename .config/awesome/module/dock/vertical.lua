...
local item_font = beautiful.ifont .. "30"
local item_bg = x.bg
local item_size = dpi(45)
local item_shape = helpers.rrect(dpi(30))
local item_margin = dpi(8) -- For spacing between items
local indicator_spacing = dpi(1)
...
-- Order matters!
dock_pinned_apps = {
    { class = "Brave-browser", launcher = apps.brave_browser },
    { class = "editor", launcher = apps.editor },
    { class = "mail", launcher = apps.mail },
    { class = "Emacs", launcher = apps.org },
    { class = "news", launcher = apps.news },
    { class = "tide", launcher = apps.torrent },
            ...
            {
                {
                    ...
                    },
                    {
                        ...
                        bg = fg,
                        shape = helpers.prrect(dpi(60), true, true, true, true),
                        visible = is_focused,
                        widget = wibox.container.background
                    },
                    forced_width = indicator_height / 2,
                    forced_height = item_size,
                    id = "indicator",
