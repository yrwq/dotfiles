...
lock_screen_box.bg = beautiful.lock_screen_bg or x.bg .. "BF" -- 75% opaque
lock_screen_box.fg = beautiful.lock_screen_fg or x.fg
...
awful.screen.connect_for_each_screen(function(s)
    if s == screen.primary then
        ...
        s.mylockscreen = helpers.screen_mask(s, beautiful.lock_screen_bg or beautiful.exit_screen_bg or x.bg)
    end
end)
...
local date = wibox.widget {
    font = beautiful.nfont .. "30",
    forced_width = dpi(1000),
    align = "center",
    valign = "center",
    widget = wibox.widget.textclock(helpers.colorize_text("%B %d, %A", x.color3))
}
...
local time = wibox.widget {
    ...
    align = "center",
    valign = "center",
    widget = wibox.widget.textclock(helpers.colorize_text("%H %M", x.color5))
}
...
local animation_colors = {
    -- Rainbow sequence =)
    x.color1, x.color5, x.color4, x.color6,
    x.color2, x.color3
}
                ...
                {
                    {
                        ...
                        forced_height = screen_height * 0.4,
