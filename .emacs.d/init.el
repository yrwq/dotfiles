...
(defun efs/org-font-setup ()
  ...
  (dolist (face '((org-level-1 . 1.2)
                  ...
                  (org-level-7 . 1.1)
                  (org-level-8 . 1.1)))
    (set-face-attribute (car face) nil :font "Iosevka Custom" :weight 'regular :height (cdr face)))
...
(use-package org
  ...
  (setq org-agenda-files
        '("/mnt/doc/org/todo.org"
          "/mnt/doc/org/notes.org"))
...
(use-package evil-nerd-commenter
  :bind ("C-ú" . evilnc-comment-or-uncomment-lines))
...
(global-set-key (kbd "C-c c") 'execute-shell-command-on-buffer)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(mu4e-views xresources-theme which-key vterm visual-fill-column use-package typescript-mode rainbow-delimiters org-bullets ivy-rich hydra helpful general forge evil-nerd-commenter evil-magit evil-collection eterm-256color eshell-git-prompt doom-themes doom-modeline counsel-projectile company-box command-log-mode base16-theme)))
(custom-set-faces
